        ...
        <div className="space-y-4">
            ...
            <div className="py-6">
                ...
                <p className="text-sm text-gray-500 mb-4 max-w-xl">
                    Uygulamanın çalışması için kendi API anahtarlarınızı
                    sağlamalısınız ya da kendi Mike kurulumunuzu çalıştırıyorsanız
                    API anahtarlarınızı `.env` dosyasına eklemelisiniz.
                </p>
                <p className="text-xs text-gray-400 mb-4 max-w-xl">
                    Başlık oluşturma, yapılandırdığınız sağlayıcının en uygun
                    maliyetli modeline otomatik olarak yönlendirilir (Gemini
                    anahtarı varsa Gemini Flash Lite, yoksa Claude Haiku).
                </p>
                <div className="space-y-4 max-w-xl">
                    <ApiKeyField
                        label="Anthropic (Claude) API anahtarı"
                        placeholder="sk-ant-…"
                ...
                >
                    <span className="flex items-center gap-2 min-w-0">
                        ...
                        <span className="truncate text-gray-900">
                            {selected?.label ?? "Bir model seçin"}
                        </span>
                    </span>
                    <ChevronDown
                            ...
                            {items.map((m) => {
                                ...
                                return (
                                    <DropdownMenuItem
                                        ...
                                        title={
                                            !available
                                                ? `Bu modeli kullanmak için ${provider === "claude" ? "Claude" : "Gemini"} API anahtarı ekleyin`
                                                : undefined
                                        }
                                    >
                                        <span
