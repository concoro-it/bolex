...
export function ApiKeyMissingModal({ open, onClose, provider, message }: Props) {
    ...
    const providerName = provider ? providerLabel(provider) : "bu sağlayıcı";
    const body =
        message ??
        `Henüz ${providerName} API anahtarı eklemediniz. Bu modeli kullanmak için hesap ayarlarınızdan ekleyin.`;
