            ...
            <div className="w-full max-w-2xl rounded-2xl bg-white shadow-2xl overflow-hidden flex flex-col" style={{ height: 600 }}>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                    ...
                    <div className="px-6 pt-3 pb-5 flex-1 overflow-y-auto">
                        ...
                        {!isEditing && (
                            <div className="mt-5">
                                <p className="mb-2 text-sm font-medium text-gray-500">Tür</p>
                        ...
                        {/* Practice */}
                        <div className="mt-5">
                            <p className="mb-2 text-sm font-medium text-gray-500">Uygulama alanı</p>
                            ...
                            {isOthers && (
                                <input
                                    ...
                                    placeholder="Uygulama alanını girin…"
